...
• hold, transfer, or manage customer funds
...
Your data is handled in accordance with our Privacy Policy. By using our Services, you consent to our data practices.

⸻

7. Limitation of Liability

To the maximum extent permitted by law, MyAiBank is not liable for:
• decisions you make based on platform information
• loss of income, data, or profits
...
We may update these Terms at any time. Continued use of the Services indicates acceptance of the updated Terms.
...
By using MyAiBank.ai/MyAiBank.com or any related services (“Services”), you agree to the practices described in this Privacy Policy.
...
• Account balances
• Merchant details
• Income and spending metadata

We do NOT collect or store your banking login credentials.
...
You may disable cookies, but certain features may not function correctly.
...
• Provide and operate MyAiBank
• Deliver AI-generated financial insights
...
Some of our service providers may store information outside Australia.
Where this occurs, they must meet privacy and data security standards consistent with Australian law.
...
Contact us at privacy@myaibank.ai.
...
MyAiBank is not intended for users under 16.
...
The updated version will be posted on the MyAiBank website with a new “Last Updated” date.

⸻

11. Contact Us

For any questions or privacy requests, contact:

Email: privacy@myaibank.ai
Trading Name: MyAiBank
Legal Entity: AI CAPITAL HOLDINGS PTY LTD
ABN: 38 693 023 371`;
