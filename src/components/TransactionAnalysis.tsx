        ...
        <div className="space-y-6 lg:col-span-3">
          <div className="space-y-4 rounded-2xl bg-white/5 p-4">
            <input
              ...
              className="w-full rounded-lg border border-white/20 bg-transparent px-3 py-2 text-sm text-white placeholder:text-white/40 focus:border-white focus:outline-none focus:ring-1 focus:ring-white"
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <div>
                ...
                <select
                  ...
                  className="mt-2 block w-full rounded-lg border border-white/20 bg-transparent px-3 py-2 text-sm text-white focus:border-white focus:outline-none focus:ring-1 focus:ring-white"
                >
          ...
          {totalPages > 1 && (
            <div className="flex items-center justify-between rounded-2xl bg-white/5 px-4 py-3 text-sm text-white/80">
              <button
                ...
                className="rounded-lg border border-white/20 px-4 py-2 font-semibold text-white transition hover:border-white disabled:cursor-not-allowed disabled:opacity-40"
              >
                Previous
              </button>
              <span>
        ...
        <div className="space-y-6 lg:col-span-2">
          <div className="space-y-4 rounded-2xl bg-white/5 p-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-lg font-semibold text-white">Spending insights</h3>
            </div>
          ...
          <div className="space-y-4 rounded-2xl bg-white/5 p-4">
            <div className="flex items-center gap-3">
              <ScissorsIcon className="h-6 w-6 text-rose-300" />
              <h3 className="text-lg font-semibold text-white">Subscription hunter</h3>
            </div>
            {isLoading && <LoadingSkeleton />}
            {analysis && analysis.subscriptions.length > 0 && (
              <ul className="space-y-3 text-sm text-white/80">
                {analysis.subscriptions.map((sub, index) => (
                  <li
                    key={index}
                    className="flex items-center justify-between gap-4 rounded-xl bg-black/20 px-3 py-3"
                  >
                    <div>
                    ...
                    <a
                      ...
                      className="flex items-center gap-1.5 rounded-full bg-white/10 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-white transition hover:bg-white/20"
