...
import { CalendarIcon, PiggyBankIcon, TargetIcon, TrashIcon } from "./icon/Icon";
      ...
      <div className="relative p-6 sm:p-8">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          <div className="space-y-2">
            ...
            <div className="mt-4 flex items-start gap-3 rounded-2xl border border-white/15 bg-white/5 p-4 text-sm text-white/75">
              <PiggyBankIcon className="mt-0.5 h-5 w-5 text-white/60" />
              <p>
                Set the goal up inside your bank or savings account first so deposits stay automatic there. Financly reads your live balances to track progress and surface milestones without moving your money.
              </p>
            </div>
          </div>
        ...
        {sortedGoals.length === 0 ? (
          <div className="mt-8 flex flex-col items-center justify-center gap-4 rounded-2xl border border-dashed border-white/20 bg-white/5 p-8 text-center text-white/70">
            ...
            <p className="max-w-xl text-sm">
              Create your first goal inside your bank, then mirror it here so we can track balances, timeline estimates, and milestones for you.
            </p>
          </div>
        ) : (
                ...
                <div key={goal.id} className="relative overflow-hidden rounded-3xl bg-white/5 p-6 backdrop-blur-sm">
                  ...
                  <div className="mt-6 grid grid-cols-1 gap-4 text-sm text-white/80 sm:grid-cols-3">
                    ...
                    <div className="rounded-2xl bg-white/10 p-4">
                      ...
                      <p className="mt-3 text-xs text-white/50">This is not Financial advice.</p>
                    </div>
                    <div className="rounded-2xl bg-white/10 p-4">
                      <p className="text-xs uppercase tracking-wide text-white/60">Bank sync tip</p>
                      <p className="mt-2 text-sm">
                        Keep this goal active with your bank’s tools. Financly watches the connected balance and reflects every deposit automatically.
                      </p>
                      <p className="mt-1 text-xs text-white/60">We never initiate transfers—everything stays with your provider.</p>
                    </div>
                  </div>
        ...
        <div className="mt-10 space-y-3 rounded-2xl border border-white/15 bg-white/5 p-6 text-sm text-white/75">
          <p className="text-base font-semibold text-white">How Financly tracks your goals</p>
          <p>
            We mirror balances from your linked accounts each time you contribute through your bank. Add manual contributions here when you move extra funds so our projections stay in sync.
          </p>
          <p className="text-xs uppercase tracking-wide text-white/50">
            Tip: schedule automated transfers in your banking app, then log them here for instant progress updates.
          </p>
        </div>
      </div>
