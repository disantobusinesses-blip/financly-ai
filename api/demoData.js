import { Transaction, SavingsPlan, Account, AccountType, SavingsOptimizationPlan } from "../types";

export const demoBalance = 9400.4;

export const demoAccounts: Account[] = [
  { id: "acc1", name: "Everyday Account", type: AccountType.CHECKING, balance: 2450.75, currency: "AUD" },
  { id: "acc2", name: "Savings Account", type: AccountType.SAVINGS, balance: 8200.1, currency: "AUD" },
  { id: "acc3", name: "Credit Card", type: AccountType.CREDIT_CARD, balance: -1250.45, currency: "AUD" },
];
...
/** Simple demo goals shown in UI cards */
...
/** Optimization plan used by AISavingsPlan + SpendingForecast */
export const demoOptimizationPlan: SavingsOptimizationPlan = {
  suggestions: [
    { category: "Subscriptions",  monthlyCut: 18.98, description: "Cancel overlapping streaming services." },
    { category: "Utilities",      monthlyCut: 22.00, description: "Switch to off-peak energy plan." },
    { category: "Dining",         monthlyCut: 45.00, description: "Cap eating out to 1/week." },
  ],
